import JSON5Wrapper from '../../vendor/JSON5.wrapper.js';
    ...
    #lastCheck(target, typeValue, value ) {
        ...
        switch (true){
            case !!this.#types[typeValue]: meOut = this.deepCheck(value, typeValue, 'type')
                break;
            case !!this.#enums[typeValue]: meOut =  Object.keys(this.#enums[typeValue]).includes(value)
                ? value
                : this.typeError([value, `member of ${typeValue} enum`]);
                break
            default:

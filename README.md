...
5. [API](#api)
    ...
    - [Basic Usage](#basic-usage)
      ...
      - [Function](#isfunction--asfunction)
      - [BigInt](#isbigint--asbigint)
      - [Array](#isarray--asarray)
      - [Buffer](#isbuffer--asbuffer)
      - [TypedArray](#istypedarray--astypedarray)
      - [SharedArrayBuffer](#issharedarraybuffer--assharedarraybuffer)
      - [Date](#isdate--asdate)
      - [Date](#isdate--asdate)
      - [Object](#isobject--asobject)
      - [Class](#you-can-even-check-the-class-type)
      - [instance](#you-can-even-check-the-class-type)
      - [Enum](#isenum--asenum)
      - [Set](#isset--asset)
      - [Map](#ismap--asmap)
      - [Iterator](#isiterator--asiterator)
      - [Nullish](#isnullish--asnullish)
      - [Nullish](#isnullish--asnullish)
      - [WeakSet](#isweakset--asweakset)
      - [WeakSet](#isweakset--asweakset)
      - [WeakMap](#isweakmap--asweakmap)
      - [WeakRef](#isweakref--asweakref)
      - [RegExp](#iseegexp--asregexp)
      - [Promise](#ispromise--aspromise)
      - [Error](#iserror--aserror)
      - [RangeError](#israngerrror--asrangeerror)
      - [ReferenceError](#isreferenceerror--asreferenceerror)
      - [ReferenceError](#isreferenceerror--asreferenceerror)
      - [SyntaxError](#issyntaxerror--assyntaxerror)

...
const structuralTypes =  ['Array', 'TypedArray','Date', 'Object', 'Set', 'Map', 'WeakSet', 'WeakMap', 'WeakRef', 'RegExp',
    'Promise', 'Error', 'RangeError', 'ReferenceError', 'SyntaxError', 'TypeError',
    'Enum']
const aliasTypes =  [{ alias: ['Argument', 'argument', 'Iterable', 'iterable', 'generator'], method4type: 'alias' }]
const otherTypes = [
